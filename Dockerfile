...
#Import Gudz
RUN wget https://raw.githubusercontent.com/Squidward-Rn7/NezukoID/master/nezukoidbotmain.py
RUN wget https://raw.githubusercontent.com/Squidward-Rn7/NezukoID/master/requirements.txt
#Start Fumkin
RUN pip3 install -r requirements.txt

CMD ["python3","nezukobotmain.py"]
