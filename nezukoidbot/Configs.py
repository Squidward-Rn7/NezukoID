...
if ENV:
    ...
    class Config(object):
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "nezukoidbot")
        ...
        UPSTREAM_REPO = os.environ.get(
            "UPSTREAM_REPO", "https://github.com/Squidward-Rn7/NezukoID"
        )
        ALIVE_IMAGE = os.environ.get("ALIVE_IMAGE", "https://telegra.ph/file/bcecc640c26dd9268941d.jpg")
        ASSISTANT_START_PIC = os.environ.get(
            "ASSISTANT_START_PIC",
            "https://telegra.ph/file/bcecc640c26dd9268941d.jpg",
        )
