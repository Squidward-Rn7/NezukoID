...
""" Userbot module for managing events.
 One of the main components of the nezukoidbot. """
...
from nezukoidbot import LOGSPAMMER, PRIVATE_GROUP_ID, bot
        ...
        async def wrapper(check):
            ...
            # This is a gay exception and must be passed out. So that it doesnt spam chats
                ...
                if not disable_errors:
                    ...
                    link = "[PaperplaneExtended Support Chat](https://t.me/NezukoIDBot)"
                    ...
                    if LOGSPAMMER:
                        await check.client.respond(
                            "`Sorry, my nezukoidbot has crashed.\
                        \nThe error logs are stored in the nezukoidbot’s log chat.`"
                        )
