...
from nezukoidbot import BOTLOG, BOTLOG_CHATID, CMD_HELP
from nezukoidbot.utils import admin_cmd, errors_handler
...
async def promote(promt):
    ...
    try:
        ...
        await promt.edit(
            f"Boss I successfully Promoted [{user.first_name}](tg://user?id={user.id}) in {promt.chat.title}"
        )
