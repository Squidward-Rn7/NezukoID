...
from nezukoidbot import CMD_HELP, lang
...
if lang == "si":
    ...
    @nezuko.on(events.NewMessage(outgoing=True))  # pylint:disable=E0602
        ...
        if ".afk" not in current_message and "yes" in USER_AFK:  # pylint:disable=E0602
            ...
            try:
                ...
                await borg.send_message(  # pylint:disable=E0602
                    ...
                    + "Please Seek Support in @nezukoidchannel\n\n `{}`".format(str(e)),
        ...
        if ".afk" not in current_message and "yes" in USER_AFK:  # pylint:disable=E0602
            ...
            try:
                ...
                await borg.send_message(  # pylint:disable=E0602
                    ...
                    "Please set `PRIVATE_GROUP_ID` "
                    + "for the proper functioning of afk functionality "
                    + "Please Seek Support in @nexukoidchannel\n\n `{}`".format(str(e)),
                    reply_to=event.message.id,
                    silent=True,
                )
            await asyncio.sleep(5)
