...
from ..utils import edit_or_reply, nezuko_on_cmd, sudo_cmd
...
@nezuko.on(nezuko_on_cmd(outgoing=True, pattern="magisk$"))
@nezuko.on(sudo_cmd(pattern="magisk$", allow_sudo=True))
...
@nezuko.on(nezuko_on_cmd(outgoing=True, pattern=r"device(?: |$)(\S*)"))
@nezuko.on(sudo_cmd(pattern="device(?: |$)(\S*)", allow_sudo=True))
...
@nezuko.on(
    nezuko_on_cmd(outgoing=True, pattern=r"codename(?: |)([\S]*)(?: |)([\s\S]*)")
)
@nezuko.on(sudo_cmd(pattern="codename(?: |)([\S]*)(?: |)([\s\S]*)", allow_sudo=True))
...
@nezuko.on(nezuko_on_cmd(outgoing=True, pattern=r"specs(?: |)([\S]*)(?: |)([\s\S]*)"))
@nezuko.on(sudo_cmd(pattern="specs(?: |)([\S]*)(?: |)([\s\S]*)", allow_sudo=True))
...
@nezuko.on(nezuko_on_cmd(outgoing=True, pattern=r"twrp(?: |$)(\S*)"))
@nezuko.on(sudo_cmd(pattern="twrp(?: |$)(\S*)", allow_sudo=True))
