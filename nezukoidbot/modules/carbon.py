...
from nezukobot import CHROME_DRIVER, CMD_HELP, GOOGLE_CHROME_BIN
from nezukobot.utils import nezuko_on_cmd

CARBONLANG = "auto"
LANG = "en"


@nezuko.on(nezuko_on_cmd(pattern="carbon"))
async def carbon_api(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        ...
        await e.client.send_file(
            e.chat_id,
            file,
            caption="<< `Here's your carbon!` \n **Carbonised By** [NezukoID](https://github.com/Squidward-Rn7/NezukoID)>>\n**Colour Scheme: **`{}`".format(
                color_name
            ),
            force_document=True,
