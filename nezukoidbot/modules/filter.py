...
from nezukoidbot.modules.sql_helper.filter_sql import (
    add_filter,
    get_all_filters,
    remove_all_filters,
    remove_filter,
...
@nezuko.on(nezuko_on_cmd(pattern="filter (.*)"))
@nezuko.on(sudo_cmd(pattern="filter (.*)", allow_sudo=True))
...
@nezuko.on(nezuko_on_cmd(pattern="filters$"))
@nezuko.on(sudo_cmd(pattern="filters$", allow_sudo=True))
...
@nezuko.on(nezuko_on_cmd(pattern="stop (.*)"))
@nezuko.on(sudo_cmd(pattern="stop (.*)", allow_sudo=True))
...
@nezuko.on(nezuko_on_cmd(pattern="rmfilters$"))
@nezuko.on(sudo_cmd(pattern="rmfilters$", allow_sudo=True))
