...
from nezukoidbot.function import get_all_modules
from nezukoidbot.utils import nezuko_on_cmd, load_module

DELETE_TIMEOUT = 5


@nezuko.on(nezuko_on_cmd(pattern="install"))
    ...
    if event.reply_to_msg_id:
        ...
        try:
            ...
            if "(" not in downloaded_file_name:
                ...
                await event.edit(
                    "NezukoID Installed `{}` Sucessfully.".format(
...
@borg.on(nezuko_on_cmd(pattern="pl ?(.*)"))
async def _(event):
