...
from var import Var
from nezukoidbot import CMD_LIST, LOAD_PLUG, SUDO_LIST, bot
from nezukoidbot.Configs import Config
from nezukoidbot.wraptools import (
    am_i_admin,
    ignore_bot,
    ignore_fwd,
    ignore_grp,
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import nezukoidbot.modules
        import nezukoidbot.utils

        path = Path(f"nezukoidbot/modules/{shortname}.py")
        name = "nezukoidbot.modules.{}".format(shortname)
        ...
        # support for uniborg
        sys.modules["uniborg.util"] = nezukoidbot.utils
        sys.modules["fire.util"] = nezukoidbot.utils
        sys.modules["userbot.utils"] = nezukoidbot.utils
        sys.modules["userbot.plugins"] = nezukoidbot.modules
        sys.modules["plugins"] = nezukoidbot.modules
        sys.modules["userbot"] = nezukoidbot
        mod.Config = Config
        ...
        sys.modules["nezukoidbot.events"] = nezukoidbot.utils
        spec.loader.exec_module(mod)
        # for imports
        sys.modules["nezukoidbot.modules." + shortname] = mod
...
def remove_plugin(shortname):
    try:
        try:
            ...
            name = f"nezukoidbot.modules.{shortname}"
...
def start_assistant(shortname):
    if shortname.startswith("__"):
        ...
        path = Path(f"nezukoidbot/modules/assistant/{shortname}.py")
        name = "nezukoidbot.modules.assistant.{}".format(shortname)
        spec = importlib.util.spec_from_file_location(name, path)
        mod = importlib.util.module_from_spec(spec)
        spec.loader.exec_module(mod)
        ...
        spec.loader.exec_module(mod)
        sys.modules["nezukoidbot.modules.assistant" + shortname] = mod
